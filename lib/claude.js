...
/**
 * Locate the claude launcher. Prefers the native binary so we can spawn without
 * a shell; the npm wrapper would need one, and on Windows a .cmd cannot be
 * spawned with shell:false at all.
 */
function resolveBin() {
